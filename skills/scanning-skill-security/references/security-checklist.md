...
Structured criteria for evaluating security risks in a skill project. Each category targets a specific file type with pattern-based checks. Use this during a security scan — work through each category, note findings with file paths and line numbers, and compile the report.
