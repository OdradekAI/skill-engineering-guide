...
**Additional shared files:** `hooks/session-start`, `hooks/run-hook.cmd` (see scaffolding-skill-projects assets for templates)
...
Template available at: `scaffolding-skill-projects/assets/hooks/run-hook.cmd`
