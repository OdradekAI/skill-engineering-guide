---
name: optimizing
description: "Use when performing engineering optimization on an existing bundles — improving skill descriptions for better triggering, reducing token usage across skills, optimizing workflow chains between skills, fixing audit findings, enhancing progressive disclosure, adding multi-platform support, or auditing skill/agents/commands folder structure for quality"
---
...
Targeted improvement of specific aspects of a bundles. Unlike a full audit, optimization focuses on goals: better triggering, lower token cost, tighter workflow chains.
...
**Announce at start:** "I'm using the optimizing skill to improve your project."
...
Fix security findings from `bundles-forge:scanning-security` or audit Category 9.
...
**Called by:**
- **bundles-forge:auditing** — when audit finds optimization opportunities

**Pairs with:**
- **bundles-forge:managing-versions** — after optimization, versions may need sync
- **bundles-forge:scanning-security** — security findings feed into remediation

**Cross-refers:**
- **bundles-forge:iterating-feedback** — when effectiveness issues go beyond engineering norms into single-skill behavior and prompt quality
