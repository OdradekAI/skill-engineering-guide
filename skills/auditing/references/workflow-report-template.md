...
This template is for **agent-authored reports** (dispatched via `agents/auditor.md`). For CLI/CI summary output, use `scripts/audit_workflow.py` (produces compact Markdown or JSON).
