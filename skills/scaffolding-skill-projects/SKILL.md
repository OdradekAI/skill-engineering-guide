...
**Announce at start:** "I'm using the scaffolding-skill-projects skill to generate your project."
...
3. **Read platform templates** — for per-platform files, load from `adapting-skill-platforms/assets/<platform>/`
