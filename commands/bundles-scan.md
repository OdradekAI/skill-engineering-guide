...
This command invokes the auditing skill in **security-only mode**. It runs only Category 10 (Security Scan) plus the `audit_security.py` script, skipping quality, structure, and documentation checks.
