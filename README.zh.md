...
**缩写：** `seg` — 在交叉引用中使用 `seg:<skill-name>` 代替完整的 `skill-engineering-guide:<skill-name>`。
...
在 Cursor 插件市场搜索 `skill-engineering-guide`，或使用 `/add-plugin skill-engineering-guide`。
...
| 技能 | 说明 |
|------|------|
| `using-skill-engineering-guide` | 引导元技能 — 建立如何发现和使用所有其他技能的入口 |
...
6. **安全** — 扫描钩子、插件、Agent 提示词和技能指令中的风险
7. **适配** — 添加更多平台支持
8. **版本** — 保持所有平台清单版本同步
9. **发布** — 编排完整的发布前验证和发布流水线
